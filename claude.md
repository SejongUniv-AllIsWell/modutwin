...
[DGX Spark] docker compose -f docker-compose.gpu-remote.yml   # 유일 GPU 워커
├── worker          (Celery training/alignment: COLMAP 전처리·gsplat 학습·문 정합·SOG 변환)
└── door-ml         (SAM3 문검출 HTTP :8000)
```
